...
//			System.out.println("In tabella ci sono " + userService.listAll().size() + " elementi.");
//			testFindByIniziale(userService);
//			System.out.println("In tabella ci sono " + userService.listAll().size() + " elementi.");
//			cercaTuttiQuelliCreatiPrimaDi(userService);
//			System.out.println("In tabella ci sono " + userService.listAll().size() + " elementi.");
//			cercaPerNomeECognomeCheInizianoPer(userService);
//			System.out.println("In tabella ci sono " + userService.listAll().size() + " elementi.");
	...
	private static void testFindByIniziale(UserService userService) throws Exception {
		System.out.println("...... inizio.............");
		String iniziale = "G";
		List<User> result = userService.cercaTuttiQuelliCheUsernameIniziaCon(iniziale);
		System.out.println(result);
	}

	// ==================================================================
	private static void cercaTuttiQuelliCreatiPrimaDi(UserService userService) throws Exception {
		System.out.println(".......User inizio.............");
		LocalDate cercaDataPrimaDi = LocalDate.parse("2024-01-01");
		List<User> result = userService.cercaTuttiQuelliCreatiPrimaDi(cercaDataPrimaDi);
		System.out.println(result);

	}
	// ==================================================================

	private static void cercaPerNomeECognomeCheInizianoPer(UserService userService) throws Exception {
		String inizialeNome = "G";
		String inizialeCognome = "P";
		List<User> result = userService.cercaPerCognomeENomeCheInziaCon(inizialeCognome, inizialeNome);
		System.out.println(result);
	}
	...
	private static void testAccedi(UserService userService) throws Exception {
		...
		System.out.println(result);
		System.out.println("test andato a buon fine");
	}
